...
class TestMethods(unittest.TestCase):
    ...
    def test_sort_errors(self):
        self.wb.set_cell_contents(self.s1, 'a1', '= 5/0')
        self.wb.set_cell_contents(self.s1, 'a2', '= shhet2!a1')
        self.wb.set_cell_contents(self.s1, 'a3', '= VERSION(1)')
        self.wb.set_cell_contents(self.s1, 'a4', '= a + 2')
        self.wb.set_cell_contents(self.s1, 'a5', '= NOT_A_FUNCTION()')
        self.wb.set_cell_contents(self.s1, 'a6', '= a6')
        self.wb.sort_region(self.s1, 'a1', 'a6', [1])
        # a2 moves up shift its content out of range
        # a1 moves down so it becomes 0 as b3 is its content
        a1_val = self.wb.get_cell_value(self.s1, 'a1')
        a2_val = self.wb.get_cell_value(self.s1, 'a2')
        a3_val = self.wb.get_cell_value(self.s1, 'a3')
        a4_val = self.wb.get_cell_value(self.s1, 'a4')
        a5_val = self.wb.get_cell_value(self.s1, 'a5')
        a6_val = self.wb.get_cell_value(self.s1, 'a6')
        self.assertIsInstance(a1_val, CellError)
        self.assertEqual(a1_val.get_type(), CellErrorType.PARSE_ERROR)
        self.assertIsInstance(a2_val, CellError)
        self.assertEqual(a2_val.get_type(), CellErrorType.CIRCULAR_REFERENCE)
        self.assertIsInstance(a3_val, CellError)
        self.assertEqual(a3_val.get_type(), CellErrorType.BAD_REFERENCE)
        self.assertIsInstance(a4_val, CellError)
        self.assertEqual(a4_val.get_type(), CellErrorType.BAD_NAME)
        self.assertIsInstance(a5_val, CellError)
        self.assertEqual(a5_val.get_type(), CellErrorType.TYPE_ERROR)
        self.assertIsInstance(a6_val, CellError)
        self.assertEqual(a6_val.get_type(), CellErrorType.DIVIDE_BY_ZERO)

    def test_sort_types(self):
        self.wb.set_cell_contents(self.s1, 'a1', '= 5/0')
        self.wb.set_cell_contents(self.s1, 'a2', '= 1')
        self.wb.set_cell_contents(self.s1, 'a3', '\'Who reads these')
        self.wb.set_cell_contents(self.s1, 'a4', '')
        self.wb.set_cell_contents(self.s1, 'a4', 'true')
        self.wb.sort_region(self.s1, 'a1', 'a5', [1])
        a1_val = self.wb.get_cell_value(self.s1, 'a1')
        a2_val = self.wb.get_cell_value(self.s1, 'a2')
        a3_val = self.wb.get_cell_value(self.s1, 'a3')
        a4_val = self.wb.get_cell_value(self.s1, 'a4')
        a5_val = self.wb.get_cell_value(self.s1, 'a5')
        self.assertIsNone(a1_val)
        self.assertIsInstance(a2_val, CellError)
        self.assertEqual(a2_val.get_type(), CellErrorType.DIVIDE_BY_ZERO)
        self.assertEqual(a3_val, decimal.Decimal(1))
        self.assertEqual(a4_val, 'Who reads these')
        self.assertEqual(a5_val, True)
